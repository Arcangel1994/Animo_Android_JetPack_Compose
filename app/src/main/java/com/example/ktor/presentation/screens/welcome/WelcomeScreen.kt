...
import com.example.ktor.util.Constants.LIST_ON_BOARDING_PAGE
import com.example.ktor.util.Constants.ON_BOARDING_PAGE_COUNT
...
fun FinishButton(
    ...
    Row(modifier = Modifier.padding(horizontal = EXTRA_LARGE_PADDING),
        ...
        AnimatedVisibility(
            ...
            visible = pagerState.currentPage == LIST_ON_BOARDING_PAGE
        ) {
